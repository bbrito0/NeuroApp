                  ...
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: RadialGradient(
                        colors: [
                          feature.background.withOpacity(0.2),
                          feature.background.withOpacity(0.05),
                        ],
                        stops: const [0.4, 1.0],
                      ),
                    ),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: feature.background.withOpacity(0.2),
      ...
      for (int i = 1; i < _numPages; i++) {
        indicators.add(
          AnimatedContainer(
            duration: const Duration(milliseconds: 300),
            curve: Curves.easeInOut,
            width: i == _currentPage ? 20.0 : 10.0,
            height: 10.0,
...
class _PersonalizedFeaturesWidgetState extends State<PersonalizedFeaturesWidget>
  ...
  Widget _buildSupplementWidget(int index, int activeIndex, AnimationPhase phase, double phaseProgress) {
    ...
    if (isActive && phase == AnimationPhase.connect) {
      ...
      final targetX = centerX - 30;
      final targetY = centerY - 15;
        ...
        child: Stack(
          children: [
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: supplementColor.withOpacity(isActive ? 1.0 : (isConnected ? 0.8 : 0.2)),
                borderRadius: BorderRadius.circular(14),
                border: Border.all(
                  color: supplementColor.withOpacity(isActive ? 1.0 : (isConnected ? 0.8 : 0.4)),
                  width: isActive ? 1.5 : 1.0,
                ),
                boxShadow: isActive ? [
                  BoxShadow(
                    color: supplementColor.withOpacity(0.5),
                    blurRadius: 10,
                    spreadRadius: 2,
                  ),
                ] : (isConnected ? [
                  BoxShadow(
                    color: supplementColor.withOpacity(0.3),
                    blurRadius: 6,
                    spreadRadius: 1,
                  ),
                ] : []),
  ...
  Widget _buildConnectionLine(int activeIndex, AnimationPhase phase, double phaseProgress) {
    ...
    return CustomPaint(
      painter: ConnectionLinePainter(
        color: supplementColor.withOpacity(0.7),
        startX: supplementX,
        startY: supplementY,
        endX: centerX,
        endY: centerY,
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: isActive ? featureColors[index].withOpacity(isAnimating ? 0.4 : 0.2) : AppColors.getPrimaryWithOpacity(0.1),
                border: Border.all(
                ...
                boxShadow: isAnimating ? [
                  BoxShadow(
                    color: featureColors[index].withOpacity(0.5),
                    blurRadius: 10,
                    spreadRadius: 2,
                  ),
                ] : (isActive ? [
                  BoxShadow(
                    color: featureColors[index].withOpacity(0.3),
                    blurRadius: 6,
                    spreadRadius: 0.5,
                  ),
                ] : null),
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: AppColors.primary.withOpacity(pulsing ? 0.4 : 0.2),
...
class ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (final particle in particles) {
      ...
      // Paint particle
      final paint = Paint()
        ..color = particle.color.withOpacity(0.7 - 0.7 * relativeProgress)
        ..style = PaintingStyle.fill;
