...
class TutorialService {
  ...
  static bool shouldShowTutorial(String tutorialId) {
    // Return true ONLY if tutorials are globally enabled
    // AND this specific tutorial has NOT been marked as shown yet.
    // Using `!= true` handles null (not found) correctly.
    return _tutorialsEnabled && (_shownTutorials[tutorialId] != true);
  }
